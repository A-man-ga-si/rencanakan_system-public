        ...
        <b-card class="mb-4 pt-4">
            <div class="d-flex justify-content-between">
                <div class="left">
                    ...
                    <h4>Export RAB - {{ `${(processedOrder?.project?.name) || '-'} (${processedOrder?.project?.address || '-'})` }}</h4>
            ...
            <div class="bottom-btn mt-4 text-right">
                <div class="success-action" v-if="processedOrder.status == 'completed' && !processedOrder.used_at">
                    ...
                    <span v-else><router-link :to="{name: 'CompanyProfile'}"><u>Isi company</u></router-link> terlebih dahulu untuk export</span>
