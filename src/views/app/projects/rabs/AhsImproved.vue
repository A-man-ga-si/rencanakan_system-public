<template>
  <div class="ahs-page mt-5">
    ...
    <div class="no-ahs text-center" v-if="Object.keys(getCustomAhs).length <= 0">
      <img
    ...
    <div class="show-ahs-content" v-else>
      <div class="ahs-content">
        <AhsItem
          v-for="(cAhs, idx) in getCustomAhs.customAhs"
          :key="idx"
...
<script>
  ...
  export default {
    ...
    computed: {
      ...mapGetters(['getCustomAhsItemableIds', 'getUnit', 'getCustomAhs']),
    },
    watch: {
      currentPage() {
        // this.getCustomAhs();
